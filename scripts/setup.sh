...
if ! command -v az &> /dev/null; then
    echo "❌ Azure CLI not found. Install it: https://docs.microsoft.com/en-us/cli/azure/install-azure-cli"
    exit 1
fi
...
if [ -n "$EXISTING_APP_ID" ]; then
    echo ""
    echo "⚠️  App '$APP_NAME' already exists with ID: $EXISTING_APP_ID"
